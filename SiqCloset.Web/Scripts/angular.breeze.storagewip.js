...
(function () {
    ...
    function zStorageWip($q, $rootScope, $window, zStorageConfig, zStorageCore) {
        ...
        function storeWipEntity(entity, entityKey, key, entityName, description, routeState) {
            ...
            if (!entityKey) { throw new Error(prefix + 'Must pass entityKey to storeWipEntity'); }
        ...
        function storeWipSummary(entity, entityKey, key, entityName, description, routeState) {
            var wipHeader = {
                id: entityKey,
                date: new Date(),
                key: key,
